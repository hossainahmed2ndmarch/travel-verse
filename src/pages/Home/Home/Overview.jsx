    ...
    <div className="container mx-auto my-10 grid grid-cols-1 md:grid-cols-2 gap-6 rounded-2xl">
      ...
      <div className="flex flex-col p-6 rounded-xl bg-secondaryBg justify-center">
        ...
        <div className="join join-vertical w-full">
          ...
          <div className="collapse collapse-arrow join-item border border-green-500">
            ...
            <div className="collapse-content text-sm sm:text-base">
              <p>
                Our website provides search filters to help you find tours that
                match your interests, budget, and schedule.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow join-item border border-green-500">
            ...
            <div className="collapse-content text-sm sm:text-base">
              <p>
                Yes, many tours offer customization options. You can adjust
                activities, duration, or request private group tours.
              </p>
            </div>
          </div>
        </div>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="modal-box bg-secondaryBg max-w-full w-11/12 sm:w-10/12 lg:w-4/5 rounded-lg shadow-lg relative">
            {/* Close Button */}
            <button
              onClick={handleModalClose}
              className="absolute top-2 right-2 btn btn-sm btn-circle text-primaryText"
            >
              ✕
            </button>
